...
describe("Pricing Engine Core: Parametric BOM & Numerical Benchmark Validation", () => {
  // --------------------------------------------------------------------------
  // 1. Scenario 1: Baseline 2-Panel Window (1.20m W x 1.20m H, with Sill)
  // --------------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------------
  // 7. Dynamic Parametric BOM Calculation (calculateParametricBOM)
  // --------------------------------------------------------------------------
  describe("Dynamic calculateParametricBOM Execution", () => {
    it("should calculate parametric BOM from explicit component and raw material lists", () => {
      const components = [
        {
          componentKey: "frame_head",
          componentName: "Head Track",
          dimensionBinding: "WIDTH" as const,
          spanRatio: 1.0,
          baseQuantity: 1,
          isRemovable: false,
          presentationCategory: "Framing" as const,
          rawMaterial: {
            id: "mat-head",
            material_code: "mat_al_head",
            description: "Head Profile",
            category: "Aluminum" as const,
            finish_type: "Analok" as const,
            billing_unit: "m" as const,
            unit_price: 100.0,
        ...
        },
        {
          ...
          rawMaterial: {
            id: "mat-sill",
            material_code: "mat_al_sill",
            description: "Sill Profile",
            category: "Aluminum" as const,
            finish_type: "Analok" as const,
            billing_unit: "m" as const,
            unit_price: 120.0,
      ...
      assert.ok(result.finalQuotation > 0);
