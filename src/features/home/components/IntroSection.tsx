...
export function IntroSection() {
  return (
    <section className="relative z-40 bg-white py-12 px-6 lg:py-25 lg:px-27.5">
      <div className="flex flex-col justify-center items-center gap-13">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium capitalize leading-tight lg:leading-[57.60px] text-black text-center">
        ...
        <div className="w-full max-w-2xl text-center text-black">
          <p className="">
