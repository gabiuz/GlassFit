...
export const mockProducts: Product[] = [
  {
    ...
    name: "Classic Window",
    category: "Window",
    description: "Standard aluminum window.",
    price: "₱ 3,000",
...
export function AddProductModal({
  ...
  const categories = Array.from(new Set(mockProducts.map((p: Product) => p.category)));
              ...
              <div className="bg-white/50 p-3 sm:p-4 flex flex-col gap-2.5 flex-1 justify-between">
                ...
                <div className="flex flex-col gap-2 mt-2">
                  ...
                  <button
                    ...
                    className="w-full py-1.5 sm:py-2 bg-black text-white text-xs sm:text-sm font-medium rounded-full hover:bg-neutral-800 transition-colors cursor-pointer"
                  >
                    Select Variant
                  </button>
                </div>
