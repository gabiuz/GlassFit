...
| QAD-TC30 | PRD-F10, PRD-F11, PRD-F14 | Canonical quotation and negotiated final price | Saved V1 quotation and authorized booking manager | 1. Compare client, public, and admin previews<br>2. Set a negotiated price<br>3. Test equal-value reset, zero confirmation, stale update, and unauthorized update<br>4. Print the quotation | Every surface renders the persisted V1 groups; original price remains immutable; effective price and transparency note are consistent; stale and unauthorized writes fail | P0 |
