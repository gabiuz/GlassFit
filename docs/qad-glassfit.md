...
| QAD-TC11 | PRD-F11 | Consultation reference PDF creation and download | Quotation calculated | 1. Click 'Download PDF Quotation'<br>2. Open generated PDF document | PDF contains the snapshot, customer details, configuration and quantity per product item, one final item price, a reconciling grand total, and disclaimer, with no BOM component costs, rates, labor, margin, original price, or negotiation note | P1 |
